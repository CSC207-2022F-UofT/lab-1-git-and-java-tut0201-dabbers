...
public class IntroLabTest {
     ...
     */
    @Test(timeout = 10)
    public void testWriteOurOwnMethod() {
        String expected = "Chen1256 Hello! My name is Stu Dent! " +
                "I like cats more than dogs! Welcome to CSC207!";
        String actual = IntroLab.writeOurOwnMethod("Chen1256", "Hello", "Stu Dent", true,
                "Welcome to CSC207!");
        assertEquals(expected, actual);
    }
}
